...
START_TEST(test_destroy_null) { pipeline_destroy(NULL); }
END_TEST
...
START_TEST(test_pop_front_null) { pipeline_pop_front(NULL); }
END_TEST
...
START_TEST(test_set_wait_null) { pipeline_set_wait(NULL, false); }
END_TEST

START_TEST(test_is_empty_null) { pipeline_is_empty(NULL); }
END_TEST

START_TEST(test_length_null) { pipeline_length(NULL); }
END_TEST

START_TEST(test_front_null) { pipeline_front(NULL); }
END_TEST
...
START_TEST(test_get_wait_null) { pipeline_get_wait(NULL); }
END_TEST

START_TEST(test_to_string_null) { pipeline_to_string(NULL); }
END_TEST
...
static void setup(void) { pipe = pipeline_new(); }
...
Suite *pipeline_suite(void) {
    ...
    tcase_add_test_raise_signal(tc_preconditions, test_push_back_scmd_null,
                                SIGABRT);
