...
START_TEST(test_external_1_simple_child) {
    ...
    ck_assert_msg(mock_execvp_last_argv[0] != NULL &&
                      strcmp(mock_execvp_last_argv[0], "command") == 0,
                  NULL);
...
START_TEST(test_external_arguments) {
    ...
    ck_assert_msg(mock_execvp_last_argv[0] != NULL &&
                      strcmp(mock_execvp_last_argv[0], "command") == 0,
                  NULL);
    ck_assert_msg(mock_execvp_last_argv[1] != NULL &&
                      strcmp(mock_execvp_last_argv[1], "arg1") == 0,
                  NULL);
    ck_assert_msg(mock_execvp_last_argv[2] != NULL &&
                      strcmp(mock_execvp_last_argv[2], "-arg2") == 0,
                  NULL);
...
START_TEST(test_pipe2_child2) {
    ...
    ck_assert_msg(mock_execvp_last_argv[0] != NULL &&
                  ...
                  NULL);
    ck_assert_msg(mock_execvp_last_argv[1] != NULL &&
                      strcmp(mock_execvp_last_argv[1], "arg3") == 0,
                  NULL);
